                    ...
                    <div class="card-body backpack-profile-form bold-labels">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input required class="form-control" type="text" name="{{$field}}" value="{{ old($field) ? old($field) : $user->detail->name }}">
                            </div>
                                @php
                                    $field = "no_telp" ;
                                @endphp
                            <div class="col-md-6 form-group">
                                <label class="required">Telphone</label>
                                <input required class="form-control" type="text" name="{{$field}}" value="{{ old($field) ? old($field) : $user->detail->no_telp }}">
                            </div>
                        </div>
                    </div>
