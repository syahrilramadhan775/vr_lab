...
<div id="video-preview" class="modal fade" role="dialog">
<div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h6 class="text-muted" id="detail-subcategory">Dessert &nbsp; </h6>
                <div class="ml-1">Tipe :  <span id="detail-type">SD</span></div>
