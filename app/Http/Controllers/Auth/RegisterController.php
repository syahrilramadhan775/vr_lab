...
use App\Models\Subcription\SubcriptionType as SubscriptionType;
use App\Models\User;
...
class RegisterController extends Controller
{
    ...
    */
    ...
    protected function create(array $data)
    {
        ...
        $user->Detail()->create([
            'name' => $data['name'],
            'no_telp' => $data['telphone'],
        ]);

        // Attach To Basic Subscription
        $user->subscribe(SubscriptionType::where('type', 'Low')->first()->id);
    ...
    /**
     * Get the guard to be used during registration.f
     *
